...
const verify=()=>{
  ...
  axios.post('http://localhost:3001/auth/forgotpass',data).then((response)=>{
...
console.log(email)
  ...
  return (
              ...
              <div className="signin-inner my-3 my-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                ...
                <Form>
                  <div className="mb-4">
                    ...
                    <InputGroup id="email" onChange={(e)=>{setEmail(e.target.value)}}>
    ...
    {errmsg}
                  ...
                  <Button variant="primary" onClick={verify} className="w-100 mt-3">
                    Recover password
                  </Button>
